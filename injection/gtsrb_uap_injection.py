...
MODEL_CLEANPATH = 'gtsrb_clean.h5'
MODEL_FILEPATH = 'gtsrb_clean.h5'  # model file
...
def train_clean():
    ...
    test_gen = base_gen.generate_data(test_X, test_Y)  # Data generator for backdoor training

    cb = SemanticCall2(test_X, test_Y)
    ...
    loss, backdoor_acc = model.evaluate_generator(test_gen, steps=200, verbose=0)
...
def convert_model():
    model = keras.models.load_model('gtsrb_clean.h5')
